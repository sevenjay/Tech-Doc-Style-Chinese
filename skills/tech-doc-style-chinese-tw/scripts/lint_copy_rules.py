...
CONTEXT_WARNING_RULES = [
    ...
    (re.compile(r"登錄系統"), "臺灣技術文件通常使用「登入系統」"),
    ...
    (re.compile(r"默認"), "臺灣技術文件通常使用「預設」"),
    (re.compile(r"接口"), "臺灣技術文件通常使用「介面」或「API」"),
    (re.compile(r"字段"), "臺灣技術文件通常使用「欄位」"),
    (re.compile(r"線程"), "臺灣技術文件通常使用「執行緒」"),
    (re.compile(r"緩存"), "臺灣技術文件通常使用「快取」"),
    (re.compile(r"調用"), "臺灣技術文件通常使用「呼叫」"),
    (re.compile(r"鏈接"), "臺灣技術文件通常使用「連結」"),
    (re.compile(r"平臺"), "臺灣慣用字通常寫「平台」"),
    (re.compile(r"感嘆號"), "臺灣標點符號通常稱為「驚嘆號」"),
    (re.compile(r"省略號"), "臺灣標點符號通常稱為「刪節號」"),
    (re.compile(r"字面量"), "臺灣技術用語通常使用「常值」或「字面值 (Literal)」"),
]
